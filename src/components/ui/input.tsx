	...
	return (
		<input
			...
			className={cn(
				...
				"bg-surface-container-high text-on-surface-variant border border-surface-container-low rounded-lg body-md-em tracking-var(--ts-body-sm) shadow-xs disabled:cursor-not-allowed disabled:opacity-50",
